...
class Dataset_M4(Dataset):
    def __init__(self, root_path, flag='pred', size=None,
                 ...
                 seasonal_patterns='Yearly', cycle=None):
        # size [seq_len, label_len, pred_len]
        self.features = features
        self.target = target
        self.scale = scale
    ...
    def __read_data__(self):
        ...
        self.cycle_index = (np.arange(len(self.timeseries)) % self.cycle)
    ...
    def __getitem__(self, index):
        ...
        # 获取对应的周期索引
        cycle_index = torch.tensor(self.cycle_index[index], dtype=torch.long)
